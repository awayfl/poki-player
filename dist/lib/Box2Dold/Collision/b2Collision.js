...
var b2Collision = /** @class */ (function () {
    ...
    // from poly1.
    b2Collision.FindMaxSeparation = function (edgeIndex /*int ptr*/, poly1, xf1, poly2, xf2) {
        var count1 = poly1.m_vertexCount;
        var normals1 = poly1.m_normals;
        var tVec;
        var tMat;
    ...
    b2Collision.b2CollidePolygons = function (manifold, polyA, xfA, polyB, xfB) {
        var cv;
        manifold.pointCount = 0;
        var edgeA = 0;
        var edgeAO = [edgeA];
        var separationA = this.FindMaxSeparation(edgeAO, polyA, xfA, polyB, xfB);
        edgeA = edgeAO[0];
        if (separationA > 0.0)
            return;
        var edgeB = 0;
        var edgeBO = [edgeB];
        var separationB = this.FindMaxSeparation(edgeBO, polyB, xfB, polyA, xfA);
        edgeB = edgeBO[0];
        if (separationB > 0.0)
            return;
    ...
    b2Collision.b2CollideCircles = function (manifold, circle1, xf1, circle2, xf2) {
        manifold.pointCount = 0;
        var tMat;
        var tVec;
    ...
    b2Collision.b2CollidePolygonAndCircle = function (manifold, polygon, xf1, circle, xf2) {
        manifold.pointCount = 0;
        var tPoint;
        var dX;
        var dY;
